...
Write `workspace/{project}/technical-spec.md`. Use the template at `.claude/templates/technical-spec.md` as your structure. This is a **complete architectural document** — no section may be a stub.
...
Write `workspace/{project}/api-spec.yaml`. Use the template at `.claude/templates/api-spec.yaml` as your structure. It must be a complete OpenAPI 3.1 document:
